...
namespace EstudioContableSpringfieldGUI
{
    public partial class FrmPrincipal : Form
    {
        ...
        public FrmPrincipal()
        {
            ...
            Categoria cat4 = new Categoria(4, "ADM B", 95000, 17, false, "");
            ...
            Empresa emp1 = new Empresa("Danonix ", "30 -34200673 - 2", "COMERCIALIZACION", DateTime.Today, "Viamonte 323");
            Empresa emp2 = new Empresa("Requiem ", "30 - 35883331 - 4", "FABRICACION", DateTime.Today, "Monseñor Bufano 1715");
            Empresa emp3 = new Empresa("Hachiko ", "33 - 213338784 - 5", "IMPORTACION", DateTime.Today, "Diagonal norte 777");
            Empresa emp4 = new Empresa("Vasere SRL ", "33 - 331234133 - 6", "AUTOMOTRIZ", DateTime.Today, "F. J. Oro 1744");
            ...
            Empleado emple1 = new Empleado("MAXIMO", "COSETTI", 36088123, 10736745, "SIEMPREVIVA 123", "20360881232", "Danonix", cat1);
            Empleado emple2 = new Empleado("CHUCK", "NORRIS", 35123122, 10736747, "DDDDDDDD", "27351231220", "Danonix", cat1);
            Empleado emple3 = new Empleado("MARIO", "SANTOS", 29225241, 602215, "DDDDDDDD", "20292252410", "Requiem", cat4);
            Empleado emple4 = new Empleado("PABLO", "LAMPONNE", 17293465, 141234, "DDDDDDDD", "20172934659", "Danonix", cat3);
            Empleado emple5 = new Empleado("EMILIO", "RAVENNA", 20416355, 6565431, "DDDDDDDD", "20204163555", "Hachiko", cat1);
            Empleado emple6 = new Empleado("NATALIA", "OREIRO", 35508182, 126254, "DDDDDDDD", "27355081827", "Vasere SRL", cat2);
